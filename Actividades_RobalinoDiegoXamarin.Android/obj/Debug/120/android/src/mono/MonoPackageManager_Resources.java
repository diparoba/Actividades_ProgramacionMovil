...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "Actividades_RobalinoDiegoXamarin.Android.dll" comes first in this list. */
		"Actividades_RobalinoDiegoXamarin.Android.dll",
		"Actividades_RobalinoDiegoXamarin.dll",
		"FormsViewGroup.dll",
